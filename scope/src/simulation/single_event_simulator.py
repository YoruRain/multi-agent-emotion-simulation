...
from .llm_reaction_generator import DEFAULT_BASE_URL, DEFAULT_MODEL_NAME, LLMReactionGenerator, ReactionParseError
...
class SingleEventSimulator:
    ...
    def __init__(
        ...
        self.model_name = self.llm_generator.model_name
        self.base_url = self.llm_generator.base_url
        self.api_key = self.llm_generator.api_key
        self.seed = seed
    ...
    async def _call_agentscope(
        ...
        return await self.llm_generator.generate(agent_record, event_message, selected_memories)
